...
function showraritytable() {
   console.log(chosenrarities);
}

function setTable(n1,n2,n3,n4,n5,n6,n7,n8,n9) {
   chosenrarities = [n1,n2,n3,n4,n5,n6,n7,n8,n9]
}
...
document.getElementById('secret').addEventListener('click', function() {
   if (boostedBySecret == false) {
      ...
      document.getElementById('boosteritem').outerHTML = "<div class='boosteritem' id='boosteritem'><h2>LETS GO GAMBLING</h2> Luck Boost: 15%</div>";
